      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-zinc-800">Instagram Account</h2>
          </div>
        </CardHeader>
        <CardContent>
          {igAccount ? (
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-full bg-gradient-to-tr from-orange-400 to-pink-500 flex items-center justify-center text-white font-bold text-sm">
            ...
            <div className="flex items-center justify-between">
              <p className="text-sm text-zinc-500">Connect your Instagram Professional account to publish Reels</p>
